...
![使用304缓存的网络请求图](/static/images/posts/1/03.png)

利用304，让浏览器使用本地缓存。但，这样也就够了吗？不成！304叫协商缓存，这玩意还是要和服务器通信一次，我们的优化级别是变态级，所以必须彻底灭掉这个请求，变成这样：

![使用本地缓存的网络请求图](/static/images/posts/1/04.png)
...
![使用构建版本号query更新资源](/static/images/posts/1/05.png)

下次上线，把链接地址改成新的版本，就更新资源了不是。OK，问题解决了么？！当然没有！大公司的变态又来了，思考这种情况：

![使用构建版本号时上线部署](/static/images/posts/1/07.png)
...
![使用摘要信息更新缓存](/static/images/posts/1/08.png)
...
![静态资源分集群部署](/static/images/posts/1/09.png)

好了，当我要更新静态资源的时候，同时也会更新html中的引用吧，就好像这样：

![CDN部署过程](/static/images/posts/1/10.png)
...
![非覆盖式发布](/static/images/posts/1/11.png)
...
![多级依赖示意图](/static/images/posts/1/14.png)
...
* 英文版：[guides.rubyonrails.org/asset_pipeline.html](http://guides.rubyonrails.org/asset_pipeline.html)
* 中文版：[guides.ruby-china.org/asset_pipeline.html](http://guides.ruby-china.org/asset_pipeline.html)
...
原文出处： [张云龙(@前端农民工)](https://github.com/fouber/blog/issues/6) 